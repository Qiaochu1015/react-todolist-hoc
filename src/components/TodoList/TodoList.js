...
import { createTodo, getTodos, deleteTodo, updateTodo} from "../../apis/TodoApi"
...
//   };
  ...
  render() {
    const { todos, handleDelete, handleSubmit, handleComplete, handleEdit, handleSave } = this.props;
            ...
            {pendingTodos.length !== 0
              ? pendingTodos.map((todo) => (
                  <TodoItem
                    ...
                    onEdit={handleEdit}
                    onSave={handleSave}
                    isEdit={todo.id === this.props.isEdit}
                  />
                ))
              : "no task to display"}
          </ul>
